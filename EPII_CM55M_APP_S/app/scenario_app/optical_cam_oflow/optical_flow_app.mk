...
APPL_DEFINES += -DTFLM_OPTICAL_FLOW
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/optical_flow_app_S_only.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/optical_flow_app_S_only.ld
endif
